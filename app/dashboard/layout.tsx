...
export default async function DashboardLayout({
  ...
  return (
    ...
    >
      ...
      {/* Desktop Sidebar */}
      <aside
        className="hidden min-h-0 w-[17rem] shrink-0 flex-col shadow-[4px_0_32px_-12px_rgba(15,23,42,0.08)] md:flex"
        style={{
      ...
      <main
        id="main-content"
        className="relative min-h-0 min-w-0 flex-1 overflow-y-auto overscroll-none p-4 pb-32 [-webkit-overflow-scrolling:touch] md:p-8 md:pb-8"
        style={{
          background:
