...
const workspaceLinks = [
  ...
  {
    href: '/dashboard/material-calculator/pvc',
    label: 'PVC BOM',
    icon: <path strokeLinecap="round" strokeLinejoin="round" d="M9 12h3.75M9 16h3.75m1.95-13.607a2.25 2.25 0 013.182 0l5.25 5.25a2.25 2.25 0 010 3.182l-9.193 9.192a2.25 2.25 0 01-1.091.645l-6.047 1.513a.75.75 0 01-.915-.915l1.513-6.047a2.25 2.25 0 01.645-1.091L16.5 7.5m-5.25-2.121 4.242 4.242" />,
  },
  {
        ...
        if (isMobile) {
          ...
          const content = (
            <>
              ...
              <span
                className={`text-[9px] sm:text-[10px] tracking-tight ${disabled ? 'line-through' : ''} ${isActive ? 'font-semibold' : 'font-medium'}`}
              >
                {link.label}
              </span>
            </>
    ...
    <nav className="flex flex-col gap-6 p-3">
      ...
      <div className="flex flex-col gap-1 border-t border-slate-100 pt-4">
        {slug && (
          ...
          >
            <svg className="h-5 w-5 shrink-0 stroke-2 text-slate-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <button
          ...
          className="flex w-full items-center gap-3 rounded-xl px-3 py-2.5 text-left text-sm font-medium text-slate-600 transition hover:bg-red-50 hover:text-red-700"
        >
          <svg className="h-5 w-5 shrink-0 stroke-2 text-slate-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
